                ...
                {{-- <div class="form-group mt-3">
                    ...
                    <div class="@error('status') is-invalid @enderror">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="statusTrial" value="Trial" 
                                {{ old('status', $student->status) == "Trial" ? 'checked' : '' }}>
                            <label class="form-check-label" for="statusTrial">Trial</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="statusEnrolled" value="Enrolled" 
                                {{ old('status', $student->status) == "Enrolled" ? 'checked' : '' }}>
                            <label class="form-check-label" for="statusEnrolled">Enrolled</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="statusDropped" value="Dropped" 
                                {{ old('status', $student->status) == "Dropped" ? 'checked' : '' }}>
                            <label class="form-check-label" for="statusDropped">Dropped</label>
                        </div>
                    </div>
                    @error('status')
                        <div class="text text-danger">
